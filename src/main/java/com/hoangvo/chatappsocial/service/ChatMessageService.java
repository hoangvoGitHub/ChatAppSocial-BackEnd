...
public class ChatMessageService {
    ...
    public void sendMessage(String to, MessagePayload chatMessage) {
//        simpMessagingTemplate.convertAndSend("/queue/" + to, chatMessage);
//        simpMessagingTemplate.convertAndSend("/queue/public", chatMessage);
